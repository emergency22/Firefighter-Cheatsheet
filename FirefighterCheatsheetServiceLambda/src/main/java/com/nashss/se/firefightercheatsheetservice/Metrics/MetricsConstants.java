...
public class MetricsConstants {
    public static final String GETAPPARATUS_APPARTATUSLISTNOTFOUND_COUNT =
        "GetApparatus.ApparatusListNotFoundException.Count";
    public static final String DELETEAPPARATUS_APPARTATUSFOUND_COUNT =
        "DeleteApparatus.ApparatusNotFoundException.Count";
